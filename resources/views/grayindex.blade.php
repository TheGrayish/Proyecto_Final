		...
		<div class="row tm-main-row">
			...
			<div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 tm-content">
					...
					<section id="tm-section-1" class="tm-section">
						<div class="ml-auto">
							<header class="mb-4"><h1 class="tm-text-shadow">Lista de normas</h1></header>
                            <div class="corner-button">
                                <a href="{{ route('gray.create') }}" class="btn">Crear registro</a>
                            </div>
                            <ul>
                                @foreach ($grays as $gray)
                                <li>
                                    <a href="{{ route('gray.show', $gray->id) }}">{{ $gray->email }}</a>
                                    <a href="{{ route('gray.edit', $gray->id) }}">Editar</a>
                                    <form action="{{ route('gray.destroy', $gray->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
